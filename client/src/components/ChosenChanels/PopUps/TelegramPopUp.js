...
import { TelegramInsideLinkPopup } from "./InsidePopUps/InsideLinkPopUp/TelegramInsideLinkPopUp";
import { ToggleButton } from "./ToggleButton";
import { KeyBoard } from "./KeyBoardPopUp";

export const TelegramPopup = (props) => {
  ...
  return (
    <div className={styles.mainArea}>
      ...
      <div>
        {toggleState && (
          <div className={stylesss.keyBoard}>
            <KeyBoard />
          </div>
        )}
      </div>

      <div>Кнопки ссылки не поддерживаются</div>
